                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            <div class="item">
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->slug_en) }}"> <img src="{{ asset($product->thumbnail) }}" alt=""> </a> </div>
                                                        <!-- /.image -->
                                ...
                                @empty
                                <h5 class="text-info">No Special Offer Product Found</h5>
                                @endforelse
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            <div class="item">
                                ...
                                @empty
                                <h5 class="text-info">No Speacial Deals Product Found</h5>
                                @endforelse
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                    ...
                    <div class="tab-content outer-top-xs">
                        ...
                        <div class="tab-pane" id="category{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    @php
                                    $filteredProducts = App\Models\Product::where('category_id', $category->id)->orderBy('id', 'DESC')->get();
                                    @endphp
                ...
                <section class="section featured-product wow fadeInUp">
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addWishlist(this.id)">
                        ...
                        @empty
                        <h5 class="text-info">No Featured Product Found</h5>
                        @endforelse
                        <!-- /.item -->
