...
@section('title')
<title>Subcategory Product</title>
@endsection
            ...
            <div class='col-md-3 sidebar'>
                ...
                <div class="sidebar-module-container">
                    <div class="sidebar-filter">
                        <!-- ============================================== SIDEBAR CATEGORY ============================================== -->
                        @include('frontend.layouts.sidebar.shop_by')
                        <!-- /.sidebar-widget -->
                    ...
                    <div id="myTabContent" class="tab-content category-list">
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    @else
                                                    <div class="product-price"> <span class="price"> ${{$product->price}}</div>
                                                    @endif
                                                    <!-- /.product-price -->
                                    ...
                                    @empty
                                    <h5 class="text-info text-center">No Product Found</h5>
                                    @endforelse
                                    <!-- /.item -->
                                </div>
                                <!-- /.row -->
                        ...
                        <div class="tab-pane " id="list-container">
                            <div class="category-product">
                                ...
                                @empty
                                <h5 class="text-center text-info">No Product Found</h5>
                                @endforelse
