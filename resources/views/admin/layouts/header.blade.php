        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    url('upload/admin/'.$admin->profile_photo_path) : url('upload/no_image.jpg') }}" alt="">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="ti-user text-muted mr-2"></i> Profile</a>
                            <a class="dropdown-item" href="{{ route('admin.edit.password') }}"><i class="ti-settings text-muted mr-2"></i> Change Password</a>
